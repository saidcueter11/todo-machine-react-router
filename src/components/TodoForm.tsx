...
export const TodoForm = ({ addTodo }: Pick<ContextType, 'addTodo'>) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='py-6 px-4 h-full w-full m-auto bg-gray-100 flex flex-col items-center rounded-md justify-evenly shadow'>
      ...
      <div className='flex justify-evenly w-full'>
        ...
        <button className='bg-blue-200 w-32 sm:w-36 h-fit px-6 py-1 shadow rounded-md hover:bg-blue-400 hover:scale-105 duration-150' type="submit">Add</button>
      </div>
    </form>
  )
}
