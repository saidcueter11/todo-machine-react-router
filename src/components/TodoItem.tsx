...
export const TodoItem = ({ description, completed, onComplete, onDelete, onEdit }: ItemProps) => {
  return (
    <li className='w-full h-20 bg-white p-2 rounded-md relative flex items-center'>
      ...
      <div className='bg-gray-50 border-2 border-indigo-700 shadow-md w-7 rounded-full h-7 absolute flex items-center justify-center -top-3 right-10 hover:bg-indigo-300 group cursor-pointer hover:scale-110 transition-all duration-200' onClick={onEdit}>
